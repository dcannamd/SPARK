...
async function runBuild() {
    ...
    try {
        ...
        for (const page of response.results) {
            ...
            // ── TIMELINE: Extract date property ─────────────────────────────
            // Supports both a Date property type and a plain text Year property.
            // In Notion, create a property named "Date" with type Date.
            // Format: YYYY-MM-DD. Used by SPARK to answer recency questions.
